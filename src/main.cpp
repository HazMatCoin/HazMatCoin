...
int64 nChainStartTime = 1428523162;
...
const string strMessageMagic = "HazMatCoin Signed Message:\n";
...
static const int64 nTargetSpacingProofOfWork = 3 * 60;		// 3 min
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in HazMatCoin
    bool fStrictPayToScriptHash = true; // Always active in HazMatCoin
...
{		
	...
	// Height is set to 1 so we always get maximum block reward.
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "HazMatCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "HazMatCoin";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("0x379c97d661c1987a6cd1a1b8dcc82ed362d14813607521d88394f0a11fee1aab"));
...
unsigned char pchMessageStart[4] = { 0xf4, 0xed, 0xe2, 0xb9 };
